...
<header class="main_header">
  <div class="row">
      <div class=""> <a class="logo" href="#"><font size="2">Online Vehicle Rental</font></a>
      <div class="mobile"> <span></span> <span></span> <span></span></div>
      <nav>
        <ul class="main-menu">
          <li><a href="inde.jsp">Home</a></li>
         
          <li><a href="login1.jsp">sign up</a></li>
          <li><a href="log.jsp">sign in</a></li>
          
          <li><a href="contact_area.jsp">Contact Us</a></li>                    
        </ul>
      </nav>
    </div>
  </div>
...
<div class="carousel fade-carousel slide" data-ride="carousel" data-interval="2000" id="bs-carousel">
  ...
  <div class="carousel-inner">
    <div class="item slides active">
      ...
      <div class="hero">
        <hgroup>
            <h1>Drive Your <span>Heart </span>Out</h1>        
            <h3>rent your ride today!</h3>
        </hgroup>
        <button class="btn btn-hero btn-lg" role="button"><a href="login1.jsp"></button>
      </div>
    </div>
    <div class="item slides">
      ...
      <div class="hero">        
        <hgroup>
            <h1>GET A <span>Driver</span></h1>        
            <h3>RIDE STRESSFREE!</h3>
        <button class="btn btn-hero btn-lg" role="button"><a href="login1.jsp"></button>
      </div>
    </div>
    <div class="item slides">
      ...
      <div class="hero">        
        <hgroup>
            <h1>ask for a <span>GUIDE</span></h1>        
  ...
  <div class="container">
    <div class="row">
      <div class="contact_section">
          <h1>Contact us</h1>
          <p>OUR TEAM INCLUDES EXPERIENCED AND CERTIFIED PERSONNEL GUARANTEEING YOU THE BEST AND MOST COMFORTABLE JOURNEY.</p>
