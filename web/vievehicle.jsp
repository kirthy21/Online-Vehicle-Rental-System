...
<html lang="en">
    ...
    <center>
        ...
        <table border="2" style="border-collapse: collapse;">
            ...
            <th> <text style="color: whitesmoke" >TYPE OF VEHICLE</text></th><th> <text style="color: whitesmoke" >VEHICLE NAME</text></th><th> <text style="color: whitesmoke" >CATEGORY</text></th>
            <th> <text style="color: whitesmoke" >COLOUR</text></th><th> <text style="color: whitesmoke" >ENGINE</text></th><th> <text style="color: whitesmoke" >MILEAGE</text></th><th> <text style="color: whitesmoke" >IMAGE</text></th>
         ...
         <td><img src="images/<%=rs.getString(6)%>" width="50" height="50"></td>
         <td><a href="delete.jsp?id=<%=rs.getString(1)%>">Delete Vehicle</a></td>
            </tr>
            <%
            }
%>
