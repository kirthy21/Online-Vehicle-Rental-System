...
//alert("haii");
    ...
    <center>
        <form action="" method="post">
            <table><tr><td>Assign Guide</td><td><select name="type" style="color:coral">
                        <%
                            ...
                            {
                            %>       
              <option value="<%=rs.getString("guide_id")%>"><%=rs.getString("guidename")%></option>
              <%}
%>
...
<%
    if(request.getParameter("save")!=null)
    {
        ...
        String ss="insert into guide_assign(gid,bid)values('"+a1+"','"+cat+"')";
