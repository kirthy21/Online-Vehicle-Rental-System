...
<html lang="en">
	...
	<body class="landing">
		...
		<!-- Header -->
			<header id="header">
				<h1><a href="userhome.jsp">User</a></h1>
				<nav id="nav">
					<ul>
						<li><a href=".addvehiclet.jsp">Gallery</a></li>
						<li><a href="v.ievehicle.jsp">About Us</a></li>
						<li><a href="vi.euser.jsp">Contact Us</a></li>
		...
		<!-- Banner -->
			<section id="banner">
				<h2>User Home</h2>
				<p>Look for your ride!</p>
                                <ul class="actions">
					<li>
						<a href="search.jsp" class="button big">Know More</a>
					</li>
				</ul>
