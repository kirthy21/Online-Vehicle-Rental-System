...
<center>
        <table border="2" style="border-collapse: collapse;">
             <th><text style="color: whitesmoke" >NAME</th><th><text style="color: whitesmoke" >ADDRESS</th>
            <th><text style="color: whitesmoke" >PHONE NO</th><th><text style="color: whitesmoke" >EMAIL</th><th><text style="color: whitesmoke" >EXPERIENCE</th>
            <th><text style="color: whitesmoke" >AGE</th><th><text style="color: whitesmoke" >GENDER</th><th><text style="color: whitesmoke" >IMAGE</th>
            <%
            ...
            <td><%=rs.getString(9)%></td>
             <td><a href="delgui.jsp?id=<%=rs.getString(1)%>">Delete Guide</a></td>
            </tr>
            <%
            }
%>
