...
<html lang="en">
  ...
  <center>
        <table border="2" style="border-collapse: collapse;">
             <th> <text style="color: whitesmoke" >USERNAME</th><th> <text style="color: whitesmoke" >NAME</th><th> <text style="color: whitesmoke" >ADDRESS</th>
            ...
            <th> <text style="color: whitesmoke" >EMAIL</th><th> <text style="color: whitesmoke" >ID PROOF</th><th> <text style="color: whitesmoke" >LICENSE</th>
            <%
            ...
            <td><a href="down.jsp?id=<%=rs.getString(9)%>">down load</a></td>
