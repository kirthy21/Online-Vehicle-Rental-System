...
<html lang="en">
  ...
  <center>
        <table border="2" style="border-collapse: collapse;">
             <th>VEHICLE NAME</th><th>USER ID</th><th>BOOKED DATE</th>
             <th>BOOKING NUMBER</th><th>days</th><th>DRIVER</th><th>GUIDE</th>
            <TH>status</th>
            <%
                String a="";
                String b="";
                ...
                String vid="";
                String sts="";
                String sql="select * from booking where status='1' and booked_date>=curdate()";
...
{
%>
<td><a href="assignguide.jsp?id=<%=id%>">assign guide</a></td>
<%
}
                }
else
