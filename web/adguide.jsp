...
<tr><td>AGE</td><td><input type="text" style="color:cadetblue" name="gage"></td></tr>
  <tr><td>GENDER</td><td><select style="color:cornflowerblue" name="gender"><option value="male">Male</option><option value="female">Female</option></select></td></tr>

<tr><td>IMAGE</TD><TD><input type="file" name="gimg" style="color:cornflowerblue"></td></tr></table>
</table>              
<table>
<tr><td>Scanned copy of driving license</td><td><input type="FILE"value="Upload" style="color:cornflowerblue"></td></tr>
<tr><td>Scanned copy of any id proof</td><td><select style="color:cornflowerblue"><option>Aadhar</option><option>Passport</option><option>Pan card</option><option>Voter id</option></select></td></tr><tr><td></td><td><input type="FILE"value="Upload" style="color:cornflowerblue"></td></tr></tr>
