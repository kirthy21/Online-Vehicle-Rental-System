...
<tr><td>PHONE NUMBER</td><td><input type="text" name="dphno"></td></tr>
<tr><td>EMAIL</td><td><input type="email" name="demail"></td></tr>
<tr><td>EXPERIENCE</td><td><input type="text" name="noofyears">in years</td></tr>
<tr><td>AGE</td><td><input type="text" name="dage"></td></tr>
<tr><td>GENDER</td><td><select name="gender" style="color:coral">
            <option value="male">male</option>
             <option value="female">female</option>
        </select></td></tr>
<tr><td>LICENSE NUMBER</td><td><input type="text" name="dlicense"></td></tr>
<tr><td>IMAGE</TD><TD><input type="file" name="dimg" style="color:coral"></td></tr>

<tr><td>Scanned copy of driving license</td><td><input type="FILE"value="Upload" style="color:coral"></td></tr>
<tr><td>Scanned copy of any id proof</td><td><select name="id" style="color:coral"><option value="Aadhar">Aadhar</option><option value="Passport">Passport</option><option value="Pan card">Pan card</option><option value="Voter id">Voter id</option></select></td></tr><tr><td></td><td><input type="FILE"value="Upload" style="color:coral"></td></tr></tr>

<tr><td></td><td><input type="submit" value="Submit" name="save"></td></tr>
</table>
    </form>
    	</section>          
    </body>
