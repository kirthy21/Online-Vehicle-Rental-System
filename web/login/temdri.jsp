     ...
     <div id="contact-us" class="parallax">
         <div class="container"><center>
          ...
          <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                 ...
                 <center><h1><text style="color: black"> View Your Driver</h1></center>
     ...
     <center>
        ...
        <%
           ...
           if(f==1)
           {
              ...
              %>
              <table border="2"><th> Name</th><th>Address</th><th>Phone</th><th>Photo</th>
           ...
           {
               out.println("You have not been assigned a Driver. Sorry for the inconvenience.");
           }
            %>
    </body>
         </table></center>
