...
<html lang="en">
  ...
  <center>
        ...
        <table border="2" style="border-collapse: collapse;">
             <th><text style="color: whitesmoke" >DRIVER NAME</th><th><text style="color: whitesmoke" >ADDRESS</th>
            <th><text style="color: whitesmoke" >PHONE NO</th><th><text style="color: whitesmoke" >GENDER</th><th><text style="color: whitesmoke" >AGE</th>
            <th><text style="color: whitesmoke" >EMAIL ID</th><th><text style="color: whitesmoke" >LICENSE NO</th><th><text style="color: whitesmoke" >EXPERIENCE</th><th><text style="color: whitesmoke" >IMAGE</th>
            <%
            ...
            <td><%=rs.getString(10)%></td>
             <td><a href="deldri.jsp?id=<%=rs.getString(1)%>">Delete Driver</a></td>
            </tr>
            <%
            }
%>
